...
export const DetailsPages = () => {
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`/posts/${post._id}`, { username: user.username, title, desc ,category})
      ...
      <section className='singlePage'>
        <div className='container'>
          ...
          <div className='right'>
            ...
            {update ? <input type='text' value={category} className='updateInput' onChange={(e) => setCategory(e.target.value)} /> : <p>{post.category}</p>}
